...
function App() {
  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        url: `https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${'AIzaSyBOhqvj-6IeF5gSkJ4tc-xsutmNfy7FOaU'}`,
        method: "post",
        data: {
  ...
  return (
    ...
    <form
      ...
      className="w-full md:w-2/3 lg:w-1/2 xl:w-1/3 text-center rounded-lg shadow-lg bg-white py-6 px-4 transition-all duration-500 transform hover:scale-110"
    >
